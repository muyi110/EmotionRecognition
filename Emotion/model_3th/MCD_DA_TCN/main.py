...
from mcd_da import MCD_DA_Model
...
if __name__ == "__main__":
    ...
    for people_num_ in people_num_list:
        ...
        for number in range(cross_validation_number):
            ...
            # 开始构建 DANN 模型实例
            dann = MCD_DA_Model(sequence_length=seq_length, kernel_size=kernel_size, num_channels=num_channels,
                                dropout=dropout, batch_size=batch_size, in_channels=input_channels, random_state=None)
